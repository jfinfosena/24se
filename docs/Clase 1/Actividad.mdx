...
* **Crear una tarea para leer el valor del potenciómetro:**
  ...
  void pot_task(void *pvParameters) {
    while (1) {
      ...
      // Puedes enviar el valor a otra tarea usando una variable global o un mecanismo de comunicación 
      // (como un semáforo, una cola o un mutex)
...
* **Crear una tarea para controlar el brillo del LED:**
  ...
  void led_task(void *pvParameters) {
    ...
    while (1) {
      // Recibe el valor del potenciómetro (puedes usar una variable global o un mecanismo de comunicación)
